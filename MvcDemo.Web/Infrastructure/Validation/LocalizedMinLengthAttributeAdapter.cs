...
{
    /// <summary>
    /// Provides an adapter for the MinLength attribute that localizes error messages in validation errors and client validation rules.
    /// </summary>
    public class LocalizedMinLengthAttributeAdapter : MinLengthAttributeAdapter
    {
        /// <summary>
        /// Initializes a new instance of the LocalizedMinLengthAttributeAdapter class.
        /// </summary>
        /// <param name="metadata">The model metadata.</param>
        /// <param name="context">The controller context.</param>
        /// <param name="attribute">The MinLength attribute.</param>
