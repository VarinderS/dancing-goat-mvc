...
{
    /// <summary>
    /// Provides an adapter for the StringLength attribute that localizes error messages in validation errors and client validation rules.
    /// </summary>
    public class LocalizedStringLengthAttributeAdapter : StringLengthAttributeAdapter
    {
        /// <summary>
        /// Initializes a new instance of the LocalizedStringLengthAttributeAdapter class.
        /// </summary>
        /// <param name="metadata">The model metadata.</param>
        /// <param name="context">The controller context.</param>
        /// <param name="attribute">The StringLength attribute.</param>
